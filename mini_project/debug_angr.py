...
def analyze_func(proj, fun, cfg):
    print(f"started runni/ng {fun.name}")
    call_state = proj.factory.call_state(0x41B886, add_options={
...
def analyse_binary(binary_name): #keep
    ...
    binary_dir = os.path.join(".", f"{binary_name}")
    output = open(binary_dir , "w")
    #os.makedirs(binary_dir, exist_ok=False)
...
def main():
    ...
    #binaries.sort()
    #binary = open("our_dataset/nero_dataset/gcc-5__Ou__nano__nano", "r")
    analyse_binary("data/gcc-5__Ou__nano__nano")
